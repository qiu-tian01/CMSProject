...
var storage = multer.diskStorage({
  ...
  destination: function (req, file, cb) {
    cb(null, PATH.resolve(__dirname, '../public/uploads/posterPic'))
  },
  // 文件名字
  filename: function (req, file, cb) {
    ...
    req.body.posterPic = '/uploads/posterPic/' + _filename
    cb(null, _filename)
  }
})
// 过滤文件类型
...
// 已经是一个中间件了
var upload = multer({ storage, fileFilter }).single('posterPic') // .single处理单文件上层
